...
export default function WorkingWithObjects() {
    const [assignment, setAssignment] = useState({
      ...
      const [module, setModule] = useState({
        id: 1, name: "Some Module",
        description: "ModMaxxing",
        course: "Intro to Something",
      });
      const ASSIGNMENT_API_URM = `${REMOTE_SERVER}/lab5/module`
  ...
  return (
    <div id="wd-working-with-objects">
      ...
      <input type="checkbox" className="form-check w-75" id="wd-assignment-completed"
      ...
      <a id="wd-update-module-name"
         className="btn btn-primary float-end"
         href={`${ASSIGNMENT_API_URM}/name/${module.name}`}>
        Update module name 
      </a>
      ...
      <a id="wd-update-module-description"
         className="btn btn-primary float-end"
         href={`${ASSIGNMENT_API_URM}/description/${module.description}`}>
      ...
      <h3>Working With Objects forModules</h3>
      <h4>Retrieving Objects for modules</h4>
      <a id="wd-retrieve-modules" className="btn btn-primary"
         href={`${REMOTE_SERVER}/lab5/module`}>
        Get Module
      </a><hr/>

      <h4>Retrieving Properties for modules</h4>
